...
public class Main {
    public static void main(String[] args) {
        ...
        missionTasks.add("Establish Communicaiton");
        ...
        System.out.println("List after the modification: " + equipment);
        ...
        String removeObjective = objectives.remove(2);
        System.out.println("Removed objective: " + removeObjective);
        System.out.println("List after removing by index: " + objectives);

            //Remove specific objective by its value
